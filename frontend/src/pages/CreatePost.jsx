...
const CreatePost = () => {
    ...
    const [links, setLinks] = useState([]) // State to store pasted links
    ...
    const handleLinkChange = (e) => {
        ...
        const foundLinks = pastedText.match(urlRegex) || []
        setLinks(foundLinks)
    }
    ...
    return (
        <div>
            ...
            <div className='px-6 md:px-[200px] mt-8'>
                <h1 className='font-bold md:text-2xl text-xl'>Create a DIY</h1>
